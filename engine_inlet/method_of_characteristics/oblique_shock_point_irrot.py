...
def wall_shock_point(pt_w_ups, y_x, dydx, pt1, pcTOL, delta, gasProps, shockDir):
    """
    testing out variation on wall shock point to address disagreement with exact solution. Using anderson's method exactly.
    """
    #unpacking
    ...
    print(f"wall flow deflection: {math.degrees(def_w)}")
...
if __name__ == "__main__":
    ...
    [pt4_dwn, pt4_ups, def4_upd, beta4, pt3p] = interior_shock_point(pt4_ups, pt4_dwn, beta4, def_4, pt1, pt3p, pcTOL, delta, gas, "neg")
    V4_ups = math.sqrt(pt4_ups.u**2 + pt4_ups.v**2)
    a4_ups = math.sqrt(gas.a0**2 - 0.5*(gas.gam-1)*V4_ups**2)
    M4_ups = V4_ups/a4_ups
    print(f"upstream mach: {M4_ups}")
    ...
    [pt4_dwn, pt4_ups, def_4, beta4, pt3p] = to_wall_shock_point(pt4_ups, pt4_dwn, beta4, def_4, pt1, pt3p, y_x_low, dydx_low, pcTOL, delta, gas, "neg")
    V4_ups = math.sqrt(pt4_ups.u**2 + pt4_ups.v**2)
    a4_ups = math.sqrt(gas.a0**2 - 0.5*(gas.gam-1)*V4_ups**2)
    M4_ups = V4_ups/a4_ups
    print(f"upstream mach: {M4_ups}")
