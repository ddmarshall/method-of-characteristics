...
class operator_funcs: 
    def __init__(self):
        ...
        self.a_alt      = lambda gam, p, rho: math.sqrt(gam*p/rho)
...
def interior_point(pt2, pt1, gasProps, delta, pcTOL, funcs): 
    ...
    R, T0, P0, gam, a0 = gasProps.R, gasProps.T0, gasProps.P0, gasProps.gam, gasProps.a0
    cp = gam*R/(gam-1)
    ...
    a1, a2 = funcs.a(a0, gam, u1, v1), funcs.a(a0, gam, u2, v2)
    ...
    lam_p, lam_m = funcs.lam_plus(u2, v2, a2), funcs.lam_min(u1, v1, a1)
    ...
    while pChange >= pcTOL:
        ...
        u24, v24 = V24*math.cos(thet24), V24*math.sin(thet24)
        u14, v14 = V14*math.cos(thet14), V14*math.sin(thet14)
        a_p, a_m = funcs.a(a0, gam, u24, v24), funcs.a(a0, gam, u14, v14)
        M_p, M_m = funcs.M(V24, a_p), funcs.M(V14, a_m)
        alph_p, alph_m = funcs.alph(M_p), funcs.alph(M_m)
        lam_p, lam_m = funcs.lam_plus(u24, v24, a_p), funcs.lam_min(u14, v14, a_m)       
        ...
        pChange = max([abs((p4-p4_old)/p4_old), abs((V4-V4_old)/V4_old), abs((rho4-rho4_old)/rho4_old)])
...
if __name__ == "__main__":
    ...
    x4, y4, u4, v4, p4, rho4 = direct_wall(pt2, pt3, y_x, dydx_x, gasProps, 1, 0.00001, funcs, "pos")
    ...
    x4, y4, u4, v4, p4, rho4 = direct_wall(pt2, pt3, y_x_mod, dydx_x_mod, gasProps, 1, 0.00001, funcs, "neg")
