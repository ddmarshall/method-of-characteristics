...
if __name__ == "__main__":
    ...
    [u4, v4, x4, y4] = interior_point_old(pt1, pt2, gasProps, 0.0001)
    print(f"old interior solution: u4,v4,x4,y4 = {u4, v4, x4, y4}")
    [x4, y4, u4, v4] = interior_point(pt2, pt1, gasProps, delta, 0.00001, funcs)
    print(f"new interior solution: u4,v4,x4,y4 = {u4, v4, x4, y4}")
    """
