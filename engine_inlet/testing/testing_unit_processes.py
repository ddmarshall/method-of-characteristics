...
class test_operators(unittest.TestCase):
    ...
    def test_dirWall_abv(self):
        ...
        res = unit_processes.direct_wall(pt1, y_x, dydx, self.gas, self.delta, 0.0001, self.funcs)
    ...
    def test_invWall_abv(self):
        ...
        res = unit_processes.inverse_wall(pt1, pt2, pt3, self.gas, self.delta, 0.0001, self.funcs)
